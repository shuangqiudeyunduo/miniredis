    ...
    Cx: Send + 'static,
{
    async fn call(&self, cx: &mut Cx, req: Req) -> Result<S::Response, S::Error> {
        ...
        let answ = self.0.call(cx, req).await;
        tracing::debug!("Sent response {:?}", &answ);
...
impl volo_gen::myredis::RedisService for S {
    async fn redis_command(&self,_req: volo_gen::myredis::RedisRequest,) -> ::core::result::Result<volo_gen::myredis::RedisResponse, ::volo_thrift::AnyhowError> {
